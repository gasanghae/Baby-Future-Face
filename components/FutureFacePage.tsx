...
import { RefreshIcon, DownloadIcon, MaleIcon, FemaleIcon, GenerateIcon } from './IconComponents';
...
const FutureFacePage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto max-w-7xl w-full grid grid-cols-1 lg:grid-cols-3 gap-8 items-center pt-8">
