...
const ImagePanel: React.FC<ImagePanelProps> = ({ imageUrl, isLoading = false, onFileChange, onFileDrop, inputId }) => {
  ...
  return (
    <div 
      className={`bg-white border-2 border-dashed ${borderColor} rounded-xl aspect-square p-4 flex flex-col items-center justify-center transition-all duration-300 w-full`}
